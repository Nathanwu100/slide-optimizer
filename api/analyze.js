...
function buildPrompt(batch) {
  return [
    ...
    "- Aim to cut each rewritten line to roughly half its original length. Titles: 8 words or fewer. Body lines: about 10 words or fewer.",
    ...
    "- `proposedText` is the new wording as plain text. No bullet characters, no markdown, no asterisks, no surrounding quotes, no trailing colon added.",
    "- Keep every fact, number, name, unit and citation that was in the original. Never invent information. Never merge two paragraphs into one.",
    "- Keep the original language of the slide.",
    "- `emphasize` lists 0-2 short phrases copied EXACTLY from your `proposedText` (not from the original) that carry the meaning of the line. Each must appear exactly once in `proposedText`. Together they must stay well under half the line. Leave the array empty for titles and for lines shorter than six words.",
    ...
    "",
    "Writing style for `proposedText`:",
